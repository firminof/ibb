...
export function DashboardInfo() {
    return (
        <div className="flex flex-col h-full">
            <header className="bg-background border-b border-border px-4 py-3 flex items-center justify-between sm:px-6">
                    ...
                    <Popover>
                        <PopoverTrigger asChild>
                            <Button variant="ghost" size="icon" className="rounded-full">
                                <img src="/vercel.svg" width="32" height="32" className="rounded-full" alt="User Avatar" />
                            </Button>
                        </PopoverTrigger>
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    <TableRow>
                                        ...
                                        <TableCell>
                                            <div className="px-2 py-1 rounded-full bg-green-100 text-green-700">Ativo</div>
                                        </TableCell>
                                        <TableCell>
                                            <Link
                                                href="#"
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell>
                                            <div className="px-2 py-1 rounded-full bg-yellow-100 text-yellow-700">Inativo</div>
                                        </TableCell>
                                        <TableCell>
                                            <Link
                                                href="#"
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell>
                                            <div className="px-2 py-1 rounded-full bg-red-100 text-red-700">Transferido</div>
                                        </TableCell>
                                        <TableCell>
                                            <Link
                                                href="#"
